...
$(document).ready(function() {
    var catagories = $('#tbl-dbcatcoll').DataTable({
        "scrollY": "500px",
        paging: false,
        "ajax": "../lib/functions.php?action=getCatagoryData&datas=-1",
        "columns": [
            { "data": "chk", "width": "4%" },
            { "data": "label" },
            { "data": "Items" },
    ...
    var collections = $('#tbl-dbcoll').DataTable({
        "scrollY": "500px",
        paging: false,
        "ajax": "../lib/functions.php?action=getCollectionData",
        "columns": [
            { "data": "chk", "width": "4%" },
            { "data": "label" },
            { "data": "collections" },
    ...
    var tempLets = $('#tbl-tpmlet').DataTable({
        ...
        "scrollY": "35vh",
        paging: false,
        "ajax": "../lib/functions.php?action=getTpmletData",
        "columns": [
            { "data": "label" },
            { "data": "size" },
    ...
    var tempLets_db = $('#tbl-tpmlet-db').DataTable({
        responsive: true,
        paging: false,
        "ajax": "../lib/functions.php?action=getTpmletDataDb",
        "columns": [
            { "data": "label" },
            { "data": "description" },
            { "data": "size" },
    ...
    var tempLets_db_pepr = $('#tbl-tpmlet-db-pepr').DataTable({
        responsive: true,
        paging: false,
        "ajax": "../lib/functions.php?action=getTpmletDataDbPaper",
        "columns": [
            { "data": "label" },
            { "data": "description" },
            { "data": "size" },
    ...
    var prinlst = $('#tbl-prnlst').DataTable({
        ...
        "scrollY": "20vh",
        paging: false,
        "ajax": "../lib/functions.php?action=getTblprintData",
        "columns": [
            { "data": "id", "width": "8%" },
            { "data": "label" },
    ...
    $('#catag-drp').on('change', function() {
        ...
        catagories.ajax.url("../lib/functions.php?action=getCatagoryData&datas=" + valsr).load();
    });

    $('.item-filter-cata').on('change', function() {
        var valsr = $('.item-filter-cata').val();
        table.ajax.url("../lib/functions.php?action=getItmData&datas=" + valsr).load();
    });
    ...
    $('#add_item_dash').submit(function(event) {
        ...
        $.ajax({
            ...
            success: function(data) // A function to be called if request succeeds
                {
                    table.ajax.url("../lib/functions.php?action=getItmData").load();
                    //table.ajax.reload( null, false );
                    //table_db.ajax.reload( null, false );
    ...
    $(document).on('click', '.del-icoImg', function(event) {
        ...
        $(this).parents('#def-imgbool').find('.grab-chkimg').attr('src', '../upload_images/icon_chk_box/default.png');
    });
    ...
    $(document).on('click', '.del-icoImgEd', function(event) {
        ...
        $(this).parents('#prop-chlddbmodel-edit-icochk').find('.grab-chkimg').attr('src', '../upload_images/icon_chk_box/default.png');
    });

    $(document).on('click', '.img-lnk', function(event) {
        var img = $(this).attr('data-img');
        $('.itm-img').attr('src', '../upload_images/items/' + img);
    });

    $(document).on('click', '.img-lnk-temp', function(event) {
        var img = $(this).attr('data-img-temp');
        $('.itm-img-temp').attr('src', '../upload_images/templates/' + img);
    });
    ...
    $(document).on('click', '.img-lnk-icochk', function(event) {
        ...
        if ($(this).hasClass('newImg')) {
            ...
            $('.itm-img-temps').attr('src', '../upload_images/icon_chk_box/' + img);
        }
    });
    ...
    $(document).on('click', '.img-lnk-icochkImpre', function(event) {
        ...
        if ($(this).hasClass('newImg')) {
            ...
            $('.itm-img-temps').attr('src', '../upload_images/image_type/' + img);
        }
    });
    ...
    $(document).on('click', '.img-lnk-temp-drplst', function(event) {
        ...
        if ($(this).hasClass('tempimagePrev')) {
            ...
            $('.itm-img-temps').attr('src', '../upload_images/icon_drp_images/' + img);
        }
    ...
    $(document).on('click', '.img-lnk-temp-pepr', function(event) {
        var img = $(this).attr('data-img-temp');
        $('.itm-img-temp-pepr').attr('src', '../upload_images/paper_templates/' + img);
    });
